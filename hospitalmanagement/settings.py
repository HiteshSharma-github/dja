...
EMAIL_HOST_USER = 'hiteshsharmahs0987@gmail.com'
EMAIL_HOST_PASSWORD = 'heloiamtheboss'  # host email password required
...
EMAIL_RECEIVING_USER = ['hiteshsharmahs0987@gmail.com']
